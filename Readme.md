...
O módulo pode ser instalado adicionando o arquivo .ZIP diretamente pelo Admin da sua loja, na Aba Módulos.

Mas caso o seu Servidor de Hospedagem não possua permissões automáticas de arquivos e pastas (mod suPHP/suExec), recomendamos que extraia o arquivo .ZIP do módulo em seu computador e envie a pasta do módulo pelo FTP para a pasta /modules/, para evitar eventuais problemas de permissões e propriedade.
